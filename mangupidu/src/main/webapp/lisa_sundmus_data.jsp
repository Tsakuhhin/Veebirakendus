	...
	<form name="FRM" accept-charset="UTF-8" method="post" action="andmetelisamine" class="lisa">
		<div>
			...
			Toimumise algus <br /> <script type="text/javascript">fill_select(document.FRM);year_install(document.FRM);
			...
			<input id="minut" value="" type="text" name="minut" size="1" maxlength="2" /> 
			-->
