...
public class NadalLugemine  extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String väljund = "select nimi,tüüp,kohad,algus,asula,aadress,looja from sundmused "
					+ "where algus >= now()::date and algus < now()::date + 7";
			...
			while (rs.next()) {
				...
				if (tuup.equals("Lauamäng")){
					data += "<img class=\"type_logo\" src=\"cards.png\" alt=\"type_logo\"/>";
				}
				else {
					data += "<img class=\"type_logo\" src=\"pc.png\" alt=\"type_logo\"/>";
				}
				data += tuup + ": " + nimi + " - " + looja + "<br>";
				data += "Aadress: "+ aadress +", "+ asula + "; algus: " + algus +"<br>";
				data += "Lisainfo: "+ "puudub." +"<br>";
